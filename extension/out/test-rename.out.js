...
// 文件内部声明的变量（应该被重命名）
var InternalPhaseSize = {
  SMALL: 0,
  MEDIUM: 1,
  LARGE: 2
};
var InternalSeverity = {
  INFO: 0,
  WARNING: 1,
  ERROR: 2
};
...
function useInternal() {
  console.log(InternalPhaseSize.SMALL);
  console.log(InternalSeverity.INFO);
}
...
// 引用内部变量的语句（应该被重命名）
var mySize = InternalPhaseSize;
var myType = InternalSeverity;